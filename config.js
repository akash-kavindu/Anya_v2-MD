...
module.exports = {
     ...
     */
    botname: process.env.BotName || "ZANTA-GAMING,
    ...
    ownernumber: process.env.Owner_Number || "94774155386",
    instagramId: process.env.Insta || "3.69_pika",

    /**
     * other details and parameters
     */
    author: process.env.Author || "Zanta𝐁𝐨𝐭𝐳 🌚🌙",
    ...
    sessionId: process.env.SESSION_ID || "GsBx_A_N_Y_A_V_2_NNkZPnHsMJKfJ7gU",
